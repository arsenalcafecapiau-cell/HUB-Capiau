...
(`capiau.js`) que manda eventos pra uma função na Vercel, que grava tudo no
...
```html
<script
  src="https://capiau-funnel-hub.vercel.app/capiau.js"
...
│   └── resumo.js           # calcula as métricas pro dashboard
├── dashboard/
│   ├── index.html
│   ├── dashboard.js
│   └── style.css
