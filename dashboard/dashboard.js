(function () {
  ...
  function fetchStats(pass, days) {
    return fetch('/api/stats?days=' + days, {
  ...
  function render(data) {
    ...
    if (!funnelIds.length) {
      content.innerHTML = '<p class="empty">Nenhum evento registrado nesse período ainda. Confira se o track.js está instalado nas suas landing pages.</p>';
      return;
    }
